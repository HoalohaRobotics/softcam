...
Softcam::Softcam(LPUNKNOWN lpunk, const GUID& clsid, HRESULT *phr) :
    CSource(NAME("Robot Softcam"), lpunk, clsid),
    ...
    m_framerate(m_frame_buffer.framerate())
{
    ...
    m_paStreams[0] = new SoftcamStream(phr, this, L"Robot Softcam Stream");
}
...
SoftcamStream::SoftcamStream(HRESULT *phr,
                         Softcam *pParent,
                         LPCWSTR pPinName) :
    CSourceStream(NAME("Robot Softcam Stream"), phr, pParent, pPinName),
